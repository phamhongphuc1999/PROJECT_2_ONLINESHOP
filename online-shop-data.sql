...
insert into Employee(Name, Birthday, Sex, Phone, Address, Username, Password, Position, Node)
...
insert into Product(NameProduct, ImportPrice, Profix, Guarantee, Amount, Sale)
values (N'Product1', 100000, 10, 10, 1000, 50),
       (N'Product2', 1000000, 20, 10, 1000, 30),
	   (N'Product3', 350000, 10, 50, 4000, 0),
	   (N'Product4', 1000000, 10, 10, 1000, 50),
	   (N'Product5', 100000, 10, 10, 1000, 50),
	   (N'Product6', 100000, 5, 10, 1000, 50),
	   (N'Product7', 100000, 25, 10, 1000, 50),
	   (N'Product8', 100000, 3, 10, 1000, 50),
	   (N'Product9', 100000, 5, 10, 1000, 50),
	   (N'Product10', 100000, 30, 10, 1000, 50),
	   (N'Product11', 100000, 1, 10, 1000, 50),
	   (N'Product12', 105000, 40, 10, 1000, 50),
	   (N'Product13', 1023000, 4, 10, 1000, 50),
	   (N'Product14', 100000, 5, 10, 1000, 50),
	   (N'Product15', 25000000, 15, 10, 1000, 50),
	   (N'Product16', 100000, 20, 10, 1000, 50),
	   (N'Product17', 100000, 25, 10, 1000, 50),
	   (N'Product18', 100000, 30, 10, 1000, 50),
	   (N'Product19', 100000, 15, 10, 1000, 50),
	   (N'Product20', 100000, 10, 10, 1000, 50),
	   (N'Product21', 100000, 10, 10, 1000, 50),
	   (N'Product22', 100000, 1, 10, 1000, 50),
	   (N'Product23', 1000000, 10, 10, 1000, 50),
       (N'Product24', 3040000, 22, 10, 1000, 30),
	   (N'Product25', 350000, 11, 50, 4000, 0),
	   (N'Product26', 100000, 16, 10, 1000, 50),
	   (N'Product27', 100000, 22, 10, 1000, 50),
	   (N'Product28', 100000, 21, 10, 1000, 50),
	   (N'Product29', 100000, 1, 10, 1000, 50),
	   (N'Product30', 100000, 8, 10, 1000, 50),
	   (N'Product31', 100000, 10, 10, 1000, 50),
	   (N'Product32', 100000, 20, 10, 1000, 50),
	   (N'Product33', 100000, 25, 10, 1000, 50),
	   (N'Product34', 100000, 30, 10, 1000, 50),
	   (N'Product35', 100000, 35, 10, 1000, 50),
	   (N'Product36', 100000, 40, 10, 1000, 50),
	   (N'Product37', 100000, 1, 10, 1000, 50),
	   (N'Product38', 100000, 2, 10, 1000, 50),
	   (N'Product39', 100000, 10, 10, 1000, 50),
	   (N'Product40', 100000, 13, 10, 1000, 5),
	   (N'Product41', 100000, 10, 10, 1000, 10),
	   (N'Product42', 100000, 4, 10, 1000, 60),
	   (N'Product43', 100000, 10, 10, 1000, 20),
	   (N'Product44', 2500000, 10, 10, 1000, 40)
