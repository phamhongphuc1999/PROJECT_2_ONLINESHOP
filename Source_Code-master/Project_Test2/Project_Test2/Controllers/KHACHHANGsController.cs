...
namespace Project_Test2.Controllers
{
    public class KHACHHANGsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MAKH,TENKH,DIACHI,SODT,GHICHU")] KHACHHANG kHACHHANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MAKH,TENKH,DIACHI,SODT,GHICHU")] KHACHHANG kHACHHANG)
        {
            if (ModelState.IsValid)
            {
